...
//
// File Contents:
//      Implementation of the ISO8583_Settle class.
//
//=============================================================================
#if defined(__GNUC__)
...
const uint8_t ISO8583_Settle::RequestBitArray[] =
{
	3,  // Processing Code
...
const uint8_t ISO8583_Settle::ResponseBitArray[] =
{
	3,  // Processing Code
	11, // Systems Trace Audit Number
	12, // Time, Transaction
...
//!
bool ISO8583_Settle::MovB3ProcCode ( )
{
