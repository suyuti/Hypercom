...
//
// File Name:
//      ISO8583_Reversal.cpp
//
// File Contents:
//      Implementation of the ISO8583_Reversal class.
//
//=============================================================================
#if defined(__GNUC__)
...
const uint8_t ISO8583_Reversal::RequestBitArray[] =
{
...
const uint8_t ISO8583_Reversal::ResponseBitArray[] =
{
	3,  // Processing Code
	4,  // Amount, Transaction
	11, // Systems Trace Audit Number
...
//-----------------------------------------------------------------------------
//!
//!      Basic constructor.The Reversal transaction is saved to the journal and
//!      the message type ID for request is 0x0200. It uses the fields defined
//!      by the table m_ReversalFunctions
//!
//! \return
//!      void
//!
...
ISO8583_Reversal::ISO8583_Reversal() :
	HypCISO8583_Transaction ( ISO8583_RevRequest, RequestBitArray,
	                          ResponseBitArray )
{
...
//! \note
//!  
//!      For Reversal processing code = 00 a0 0x 
//!      a = account selection, x = processing flow	 
//!
bool ISO8583_Reversal::MovB3ProcCode ( )
{
	...
	if( m_bIsRequesting )
	{
		...
		Buffer[0] = 0x00;	// Reversal transaction
